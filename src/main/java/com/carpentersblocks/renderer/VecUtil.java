		...
		switch (quad.getFacing()) 
		{
    		...
    		case NORTH:
    			if (floatY) 
    			{
    				return new UV[] 
    				{
        				new UV(vecs[3].x, vecs[1].y),
        				new UV(vecs[2].x, vecs[0].y),
        				new UV(vecs[1].x, vecs[3].y),
        				new UV(vecs[0].x, vecs[2].y)
        			};
    			} 
    			else 
    			{
    		...
    		case SOUTH:
    			if (floatY) 
    			{
    				return new UV[] 
    				{
        				new UV(vecs[0].x, vecs[1].y),
        				new UV(vecs[1].x, vecs[0].y),
        				new UV(vecs[2].x, vecs[3].y),
        				new UV(vecs[3].x, vecs[2].y)
        			};
    			} 
    			else 
    			{
    		...
    		case WEST:
    			if (floatY) 
    			{
    				return new UV[] 
    				{
        				new UV(vecs[0].z, vecs[1].y),
        				new UV(vecs[1].z, vecs[0].y),
        				new UV(vecs[2].z, vecs[3].y),
        				new UV(vecs[3].z, vecs[2].y)
        			};
    			} 
    			else 
    			{
    		...
    		case EAST:
    			if (floatY) 
    			{
    				return new UV[] 
    				{
        				new UV(vecs[3].z, vecs[1].y),
        				new UV(vecs[2].z, vecs[0].y),
        				new UV(vecs[1].z, vecs[3].y),
        				new UV(vecs[0].z, vecs[2].y)
        			};
    			} 
    			else
    			{
    			...
    			switch (location) 
    			{
	    			...
	    			case WEST:
	    				...
	    				if (floatY) 
	    				{
		    				return new UV[] 
		    				{
		    					new UV( 0.0D, vecs[1].y),
		    					new UV( 0.0D, vecs[0].y),
		    					new UV(depth, vecs[3].y),
		    					new UV(depth, vecs[2].y)
		    				};
	    				} 
	    				else 
	    				{
	    			...
	    			default: //case EAST:
	    				...
	    				if (floatY) 
	    				{
		    				return new UV[] 
		    				{
	            				new UV(depth, vecs[1].y).invertU(),
	            				new UV(depth, vecs[0].y).invertU(),
	            				new UV( 0.0D, vecs[3].y).invertU(),
	            				new UV( 0.0D, vecs[2].y).invertU()
		    				};
	    				} 
	    				else 
	    				{
